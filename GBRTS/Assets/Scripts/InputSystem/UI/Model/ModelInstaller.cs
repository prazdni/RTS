...
namespace UI.Model
{
    public class ModelInstaller : MonoInstaller
    {
        ...
        {
            Container.Bind<CommandCreatorBase<IProduceUnitCommandEllen>>().To<ProduceUnitEllenCommandCreator>().AsTransient();
            Container.Bind<CommandCreatorBase<IProduceUnitCommandChomper>>().To<ProduceUnitChomperCommandCreator>().AsTransient();
